...
The Thousand Brains Theory proposes that every cortical column is capable of learning complete models, which means that object recognition does not occur solely at the top of the hierarchy. It occurs in every column, at all levels.  
